...
const sendResetPasswordEmail = async ({ name, email, token }) => {
  ...
  const message = `<p>Follow this link to reset your ${process.env.COMPANY_NAME} password for your ${email} account. <a href="${resetURL}" target="_blank">Reset Password</a></p>
